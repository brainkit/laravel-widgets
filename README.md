[![Build Status](https://travis-ci.org/Brainkit/laravel-widgets.svg?branch=2.0)](https://travis-ci.org/Brainkit/laravel-widgets)

#Widgets for Laravel

*This packages provides widget functionality to boost your Laravel views. Includes asynchronous mode and generator.*

### For Laravel 4, please use the [1.0 branch](https://github.com/Brainkit/laravel-widgets/tree/1.0)!

## Installation

```composer require brainkit/laravel-widgets```
